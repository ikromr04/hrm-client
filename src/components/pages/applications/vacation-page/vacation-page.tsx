...
function VacationPage(): ReactNode {
  ...
  return (
    <ApplicationsLayout>
      ...
      <Application ref={ref}>
        ...
        <div contentEditable>
          Прошу предоставить мне ежегодный оплачиваемый отпуск в период с 1-го марта по 1 апреля 2024 года, продолжительностью 31-ти календарных дней.
        </div>

        <div>
          <div contentEditable>«__» март 2024 год</div>
          <div contentEditable>
            С уважением, <br />
